...
See [Application behavior](application-behavior.md) for the full startup sequence, cloud synchronization, and Memfault integration, and [Architecture](architecture.md) for the modules and their state machines.
...
| [Architecture](architecture.md) | The modules of this application, how they interact, and their state machines |
| [Common architecture](../../../doc/architecture.md) | The zbus and SMF patterns shared by all the applications |
