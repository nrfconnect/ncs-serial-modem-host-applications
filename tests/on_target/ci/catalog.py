...
PROVISION_NRF93M1_TEST_ID = "93m1_ppp-provision-nrf93m1"
...
FOTA_NRF93M1_TEST_ID = "93m1_ppp-application-fota-nrf93m1"
...
def main(argv: list[str] | None = None) -> None:
    ...
    matrix_parser = subparsers.add_parser(
        "matrix",
        help="Emit CI run flags for provision (nRF54L15, nRF54LM20B, nRF93M1), location, coredump, and FOTA tests (L15, LM20B, nRF93M1)",
        allow_abbrev=False,
    )
