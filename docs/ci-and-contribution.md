...
The Serial Modem uses the nRF91M1 UART pinout; the bench is wired for it — see [`applications/91m1_ppp/hardware-setup.md`](applications/91m1_ppp/hardware-setup.md).
